              ...
              <div className="max-w-3xl mx-auto px-4 sm:px-7 py-10 flex flex-col gap-8">
                {posts.map((post, index) => (
                  <HardwareAnimated
                    ...
                    delay={index * 0.08}
                  >
                    <article className="group border-b border-dashed border-primary/10 pb-8 last:border-b-0">
                      <div className="flex items-center gap-3 text-xs font-mono text-secondary mb-2">
