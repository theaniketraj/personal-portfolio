...
excerpt: >-
  ...
  CDN delivery.
metaTitle: "What Happens When You Open a Website ‣ From DNS to Rendering"
metaDescription: "A deep technical walkthrough of the end-to-end process when you open a website—from DNS lookup and TCP/TLS handshakes to HTML parsing, rendering, and CDN delivery."
tags:
  - Networking
  - Web Architecture
  - System Design
...
contentType:
  - Deep Dive
relatedArticles:
  - modern-web-delivery-cms-cdn-ssg-ssr
  - google-search-algorithm-guide
---
