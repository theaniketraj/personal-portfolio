...
metaTitle: VITALS Real-time Observability for VS-Code | Aniket Raj's Project
metaDescription: Vitals is a developer-first observability tool designed to bring real-time application insights directly into your Visual Studio Code environment.
metaTags:
  - property: "og:title"
...
[Repo ↗](https://github.com/theaniketraj/vitals)
[Portal ↗](https://theaniketraj.github.io/vitals)
[Marketplace ↗](https://marketplace.visualstudio.com/items?itemName=theaniketraj.vitals)
[Open VSX ↗](https://open-vsx.org/extension/theaniketraj/vitals)
