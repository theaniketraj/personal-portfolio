...
client: Aniket Raj
description: >-
  A smart recycling bin system designed to automate and incentivize the process
  of recycling plastic bottles.
metaTitle: "Plastecure | IoT-Based Smart Recycling Bin System"
metaDescription: "A smart recycling bin system designed to automate and incentivize the process of recycling plastic bottles."
tags:
  - IoT
  - Supabase
  - ESP32
...
<TLDR>
  - **What it is:** Plastecure is an IoT-based smart recycling bin system designed to automate plastic waste segregation and incentivize recycling.
  - **Why it matters:** It encourages sustainable waste management by leveraging smart tech to identify, sort, and process plastic waste at the source.
  - **Key Tech:** ESP32 microcontrollers, Supabase, Python, C/C++, and real-time sensor analytics.
</TLDR>
...
[GitHub ↗](https://github.com/theaniketraj/plastecure)
