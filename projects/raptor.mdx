...
date: "2025-02-01"
client: Aniket Raj
description: An embedded IoT solution built into motorcycle helmets that detects accidents in real time and automatically sends emergency alerts.
metaTitle: Raptor | Smart Helmet with Accident Detection & Emergency Alert | Aniket Raj's Project
metaDescription: Raptor is an IoT-based smart helmet designed to enhance rider safety through real-time accident detection and emergency alert systems.
metaTags:
  - property: "og:title"
    content: Raptor
  - property: "og:url"
